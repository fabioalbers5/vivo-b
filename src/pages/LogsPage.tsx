...
const LogsPage: React.FC = () => {
  ...
  const statusContrato = log.status_contrato || "-";
  ...
  return <TableRow key={log.id} className="hover:bg-muted/50">
    ...
    <TableCell className="text-xs">
      <div className="truncate max-w-[140px]">{statusContrato}</div>
    </TableCell>
  </TableRow>; 
