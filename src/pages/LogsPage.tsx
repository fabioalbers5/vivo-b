...
const LogsPage: React.FC = () => {
  ...
  return <TableRow key={log.id} className="hover:bg-muted/50">
    ...
    <TableCell className="text-xs" title={tipoFluxoCompleto}>
      <Badge variant="outline" className="text-xs truncate max-w-[120px] inline-block">{tipoFluxoCompleto}</Badge>
    </TableCell>
  </TableRow>; 
